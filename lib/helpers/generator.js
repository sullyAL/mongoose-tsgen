...
export const sanitizeModelName = (name) => sanitizeTypeIdentifier(name);
...
export const convertFuncSignatureToType = (funcSignature, funcType, modelName) => {
...
export const replaceModelTypes = (sourceFile, modelTypes, models) => {
...
export const addPopulateHelpers = (sourceFile) => {
    sourceFile.addStatements("\n" + templates.POPULATE_HELPERS);
};
export const overloadQueryPopulate = (sourceFile) => {
    sourceFile.addStatements("\n" + templates.QUERY_POPULATE);
};
export const createSourceFile = (genPath) => {
...
export const parseFunctions = (funcs, modelName, funcType) => {
    let interfaceString = "";
...
export const getSchemaTypes = (model) => {
...
export const generateTypes = ({ sourceFile, imports = [], modelsPaths, noMongoose, datesAsStrings }) => {
...
export const saveFile = ({ sourceFile }) => {
    try {
        sourceFile.saveSync();
    }
    catch (err) {
