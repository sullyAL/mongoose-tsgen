...
export const getObjectDocs = (modelName) => `/**
 ...
 * \`\`\`
 */`;
export const getDocumentDocs = (modelName) => `/**
 ...
 * \`\`\`
 */`;
export const getSchemaDocs = (modelName) => `/**
...
export const getLeanDocs = (modelName, fullName) => `/**
 ...
 * \`\`\`
 */`;
export const getSubdocumentDocs = (modelName, path) => `/**
