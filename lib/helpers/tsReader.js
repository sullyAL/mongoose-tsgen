...
export const getModelTypes = (modelsPaths, maxCommentDepth = 2) => {
...
export const registerUserTs = (basePath, noExperimentalResolver) => {
...
export function parseTSConfig(tsconfigFilePath) {
