...
export const getSubdocName = (path, modelName = "") => {
...
export const isMapType = (val) => {
    return val === Map || val === mongoose.Schema.Types.Map;
};
export const convertBaseTypeToTs = ({ key, val, isDocument, noMongoose, datesAsStrings }) => {
...
export const getShouldLeanIncludeVirtuals = (schema) => {
...
export const loadModels = (modelsPaths) => {
...
export const getTypeFromKeyValue = ({ key, val: valOriginal, isDocument, shouldLeanIncludeVirtuals, noMongoose, datesAsStrings }) => {
